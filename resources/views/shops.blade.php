                    ...
                    @foreach($items as $data)
                        ...
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                @if($prefix?->effect)
                                    <p class="mt-4 text-xl" style="color: seagreen;">
                                        {{ ucfirst($prefix->effect) }}
                                    </p>
                                @endif
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                @if($item?->name)
                                    <h2 class="text-xl font-semibold text-black dark:text-white">{{ ucfirst($item->name) }}</h2>
                                @endif
